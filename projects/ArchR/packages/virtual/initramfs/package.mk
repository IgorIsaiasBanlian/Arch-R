...
PKG_URL=""
PKG_DEPENDS_INIT="libc:init busybox:init util-linux:init e2fsprogs:init dosfstools:init spleen-font:init avfs:init archr-splash:init wireless-regdb:init"
